    ...
    <div className="hero-section text-center">
      <div className="overlay">
        ...
        <img
          ...
          style={{ maxWidth: '100%' }} // Adjust image width for mobile
        />
        <div className="mt-4">
          <p>
      ...
      <section id="hungarian-folktales" className="features-section">
        ...
        <div className="features" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          {/* Hungarian Folklore and Ethnography */}
          <div className="feature" style={{ marginBottom: '20px', textAlign: 'center', width: '90%' }}>
            <a href="https://youtu.be/E-nSlaBmk8g?si=SOhAahKngvi356ew" target="_blank" rel="noopener noreferrer">
              <img src="https://img.youtube.com/vi/E-nSlaBmk8g/0.jpg" alt="The Shepherd Paul" className="feature-icon" style={{ width: '100%', maxWidth: '300px' }} /> {/* Adjust image width for mobile */}
          ...
          <div className="feature" style={{ marginBottom: '20px', textAlign: 'center', width: '90%' }}>
            <a href="https://youtu.be/JiLFlJDxRhw?si=5wt8K4ZltCsIsL8J" target="_blank" rel="noopener noreferrer">
              <img src="https://img.youtube.com/vi/JiLFlJDxRhw/0.jpg" alt="The Tree That Reached the Sky" className="feature-icon" style={{ width: '100%', maxWidth: '300px' }} /> {/* Adjust image width for mobile */}
          ...
          <div className="feature" style={{ marginBottom: '20px', textAlign: 'center', width: '90%' }}>
            <a href="https://youtu.be/hCrvFIJWjv8?si=f7wlj0rVYLelOO9x" target="_blank" rel="noopener noreferrer">
              <img src="https://img.youtube.com/vi/hCrvFIJWjv8/0.jpg" alt="The Coat of Many Colors" className="feature-icon" style={{ width: '100%', maxWidth: '300px' }} /> {/* Adjust image width for mobile */}
          ...
          <div className="feature" style={{ marginBottom: '20px', textAlign: 'center', width: '90%' }}>
            <a href="https://youtu.be/a226flenKH8?si=-I2mhJAuJdOeOwRP" target="_blank" rel="noopener noreferrer">
              <img src="https://img.youtube.com/vi/a226flenKH8/0.jpg" alt="The Three Princes and Their Beasts" className="feature-icon" style={{ width: '100%', maxWidth: '300px' }} /> {/* Adjust image width for mobile */}
