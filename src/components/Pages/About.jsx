      ...
      <div className="row">
        <div className="col-md-8 offset-md-2">
          ...
          <p style={paragraphStyle}>
            My name is Beata Konya. I am a 28-year-old Hungarian actress and student at Goldsmiths, University of London. For my final project, I conducted research into folklore, specifically exploring folktales in connection to the cycle of life and theatre.
          </p>
          <p style={paragraphStyle}>
